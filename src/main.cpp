...
unsigned int nStakeTargetSpacing = 90;		// 90 sec block spacing for PoS
unsigned int nWorkTargetSpacing = 90;		// 90 sec block spacing for PoW
unsigned int nTargetSpacing = nWorkTargetSpacing;

unsigned int nStakeMinAge = 24 * 60 * 60;	// 24 hrs
unsigned int nStakeMaxAge = -1;  // unlimited days
unsigned int nModifierInterval = 8 * 60; // CircuitCoin - time to elapse before new modifier is computed
...
const string strMessageMagic = "CircuitCoin Signed Message:\n";
...
static const int YEARLY_POS_BLOCK_COUNT = 350400;
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // CircuitCoin: check proof-of-stake block signature
...
// CircuitCoin: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CircuitCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "CircuitCoin: a coin friendly for ASICs!";
        CTransaction txNew;
        txNew.nTime = 1480358786;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
	...
	/*
	   ...
	   */
        ...
        assert(block.hashMerkleRoot == uint256("0x1352829ac55474d71579be168ba387fbb6cbc6346c8566d91dad10bd43b9d445"));
...
unsigned char pchMessageStart[4] = { 0xc3, 0xdb, 0xc0, 0xfc };
